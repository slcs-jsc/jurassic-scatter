...
You can either download the code as a .zip (.tar) file or use git clone. For the git clone move to the directory where you want to put the code and type:
...
\item *.tab: emissivity tables for each trace gas
\item *.filt: filter functions for each spectral window
\item aero1.tab: aerosol/cloud geometry and microphysical properties
\item complex refractive index file as given in aero.tab
\end{itemize}
